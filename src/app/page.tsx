...
export default function Home() {
    return (
        <div>
            <div className="shadow-md z-50 relative shadow-black bg-[url('../../public/stacked-waves-haikei.png')] bg-no-repeat">
                <div className="p-4">
                    <Drew />
                </div>
            </div>
            <div className="bg-blue-950">
                <div className={`p-4 grid grid-cols-3 auto-rows-fr gap-4`}>
                    ...
                    <FeatureCard visuals={<iframe className="showcaseImage" src="https://www.youtube.com/embed/wGrG0AuZLIs" allowFullScreen width={"max"} height={"max"}/>} description="First successful online testing of core gameplay mechanics after implementing multiplayer with Photon Fusion"/>
                </div>
            </div>
        </div>
    );
